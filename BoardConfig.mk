...
-include vendor/lenovo/s899t/BoardConfigVendor.mk

TARGET_SPECIFIC_HEADER_PATH := device/lenovo/s899t/include
TARGET_SPECIFIC_HEADER_PATH += device/lenovo/s899t/hardware
...
BOARD_EGL_CFG := device/lenovo/s899t/prebuilt/config/egl.cfg
...
# ril implementation
BOARD_RIL_CLASS := ../../../device/lenovo/s899t/telephony-common/

# Custom boot
TARGET_PROVIDES_INIT_RC := true
TARGET_RECOVERY_PRE_COMMAND := "/system/bin/touch /cache/recovery/boot; /system/bin/sync;"
BOARD_CUSTOM_BOOTIMG_MK := device/lenovo/s899t/custombootimg.mk
TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := device/lenovo/s899t/releasetools/semc_ota_from_target_files
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/lenovo/s899t/recovery/recovery-keys.c
...
#CWM recovery fix
TARGET_RECOVERY_FSTAB = device/lenovo/s899t/prebuilt/root/fstab.st-ericsson
...
TARGET_KERNEL_SOURCE := kernel/lenovo/u8500
...
BOARD_CMDLINE := device/lenovo/s899t/prebuilt/config/cmdline.txt
